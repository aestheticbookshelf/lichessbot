...
class ServerEngine_ extends chessboard.AbstractEngine{
    constructor(sendanalysisinfo, stockfishPath){
        ...
        console.log("created server engine", this.stockfishPath)        
    }
...
class LocalEngine_ extends chessboard.AbstractEngine{
    constructor(sendanalysisinfo, stockfishPath){
        ...
        this.stockfishPath = stockfishPath
        console.log("created local engine", this.stockfishPath)        
    }
...
class LichessBotGame_{
    ...
    constructor(props){
        ...
        console.log("game created by bot", this.parentBot)
        console.log("bot props", this.parentBot.props)
